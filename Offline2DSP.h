...
// Буфер для промежуточного хранения данных:
    struct Buffer {
        ...
        QVector<QRect>  width_67_100;   // Вектор для изделий шире 2/3 ширины листа-заготовки (шире 67%)
        QVector<QRect>  width_51_66;   // Вектор для изделий шире 1/2 но уже 2/3 ширины листа-заготовки
        QVector<QRect>  width_0_50;     // Вектор для всех остальных изделий
    }buffer;
};
